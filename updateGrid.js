...
const data = JSON.parse(fs.readFileSync('./src/final.json', 'utf-8'));


export default function updateGrid(prevDate, date) {



  //const prevDate = '3/22/2025'
  //const date = '3/23/2025'
